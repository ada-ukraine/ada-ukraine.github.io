...
подолати цю проблему оголосивши запит на розробку единої, сучасної мови
...
Даний матеріал базується на стандарті 2012 року загалом і не зосередженний на
...
призначення, вона повністю розкривається в низькорівневих застосунках, таких як:

- Вбудовані системи з жорсткими лімітами пам'яті (заборонено використовувати збирача сміття).
...
залізниця та багато інших. Ці застосунки вимагають високого рівня безпеки, а дефекти призводять
не тільки до незручностей, але можуть мати й важкі наслідки. Ada надає безпекові можливості, які
виявляють дефекти вже на ранній стадії — зазвичай на етапі компіляції, або ще раніше - на етапі
статичного аналізу. Ada також може використовуватись для створення застосунків у багатьох інших
областях, як наприклад:
...
З точки зору сучасних мов програмування найближчими за цілями та рівнем абстракції є
...
Філософія Ada відрізняється від більшості інших мов програмування. В основі дизайну Ada лежать
наступні принципи:

-  Читабельність важливіша за лаконічність. Синтаксично це виражається через
   факт, що перевага надається ключовим словам над символами, а ключові слова
   не є абревеатурами і т.д

-  Дуже строгі і детально описані типи. Створення нових типів дуже зручне та запобігає неправильному
   використанню даних.
